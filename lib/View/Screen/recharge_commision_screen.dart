...
import 'package:virzanpay/Controller/recharge_commission_controller.dart';
...
class RechargeCommissionScreen extends StatelessWidget {
  const RechargeCommissionScreen({super.key});
  @override
        ...
        children: [
          ...
          Align(
            ...
            child: Container(
                ...
                child: Center(child: Consumer<RechargeCommissionController>(
                    builder: (context, controller, _) {
                  return Text("INR ${controller.rechargebalance}");
                }))),
          ),
          SizedBox(
...
class TodayRecharge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: () async {
        await Provider.of<RechargeCommissionController>(context)
            .checkrechargeebalance();
        await Provider.of<RechargeCommissionController>(context)
            .checkRechargeCommission();
      },
  ...
  Future<void> fetchData(BuildContext context) async {
    final controller = Provider.of<RechargeCommissionController>(
      context,
      listen: false,
    );
    await controller.checkrechargeebalance();
    await controller.checkRechargeCommission();
  }
  ...
  Widget buildDataWidget(BuildContext context) {
    final list = Provider.of<RechargeCommissionController>(
      context,
    ).rechargeCommissionlist;
    return Container(
